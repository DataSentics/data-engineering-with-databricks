...
# MAGIC SELECT *,current_timestamp() AS receipt_time, input_file_name() AS source_file FROM bronze_temp 
...
# MAGIC SELECT state, count(customer_id) AS customer_count FROM silver_temp
