...
-- sales_orders_cleaned will not work. To use that table, we must write "FROM LIVE.sales_orders_cleaned"
-- That is because "sales_orders_cleaned" is a DLT table, and in order to be referenced the LIVE prefix must be used
