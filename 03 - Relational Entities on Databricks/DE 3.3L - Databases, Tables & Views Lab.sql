...
CREATE TABLE IF NOT EXISTS weather_managed AS SELECT * FROM
parquet.`${DA.paths.datasets}/weather/StationData-parquet`
...
-- MAGIC 
-- MAGIC 
-- MAGIC Now create a temporary view named `celsius_temp`
