...
-- TODO
MERGE INTO beans b1 USING new_beans b2
ON b1.name = b2.name AND b1.color = b2.color
WHEN MATCHED THEN UPDATE SET grams = b1.grams + b2.grams
WHEN NOT MATCHED AND b2.delicious = true THEN INSERT *
